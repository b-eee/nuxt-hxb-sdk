...
Begin with, let's setup your app with configs
```ts
...
![workspace page](assets/img/screenshot-workspace.png)
...
![create application](assets/img/screenshot-createApp.png)
...
![view item](assets/img/screenshot-item.png)
...
or add an item
![create item](assets/img/screenshot-createItem.png)
